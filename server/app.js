...
app.get("/goodsList",(req,res)=>{
  ...
  obj.push({id:2,title:"中辣椒",old:1999,now:999,img_url:"http://127.0.0.1:3000/img/banner2.png"});
  obj.push({id:3,title:"大辣椒",old:1999,now:999,img_url:"http://127.0.0.1:3000/img/banner3.png"});
  obj.push({id:4,title:"小小辣椒",old:1999,now:999,img_url:"http://127.0.0.1:3000/img/banner4.png"});
  res.send(obj);
})
...
app.get("/shop",(req,res)=>{
  var obj = [
    {id:1,img_url:"http://127.0.0.1:3000/img/niupai.png"},
  ];
  res.send(obj);
});
...
app.post("/upload",upload.single("mypic"),(req,res)=>{
  ...
  //4.判断类型 image  image/png image/gif  image/jpeg
